            ...
            pictures:
                _default:
                    sources:
                        ...
                        - { srcset: [{ version: sm }], attrs: { media: "(min-width: 5.3w)", sizes: "100vw" } }
...
<picture >
    ...
    <source media="(min-width: 5.3w)" sizes="100vw" srcset="https://storage.googleapis.com/<my-bucket-name>/<media-id>/<media-version-id>.sm.jpg" />
